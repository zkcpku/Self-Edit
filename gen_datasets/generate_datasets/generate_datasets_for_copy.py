...
print(len(pycodegpt_generations))
question_ids = list(pycodegpt_generations.keys())
# print(question_ids)
...
print(len(correct_solutions))
print(sum([len(e) for e in correct_solutions.values()]))
