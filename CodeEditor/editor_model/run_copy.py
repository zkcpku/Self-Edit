...
from dataset_copy import copyDataset
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    if args.use_pool:
        ...
        pool = None
    dataset = copyDataset(tokenizer, args, logger, file_type='dev' if evaluate else 'train',
...
def eval_and_save(args, model, tokenizer, file_type='test', save_prefix = 'last',num=20000000):
    if args.use_pool:
        ...
        pool = None
    dataset = copyDataset(tokenizer, args, logger, file_type=file_type, block_size=args.block_size, mode='test',pool=pool)
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--code_and_msg", default=None, type=str, required=True,
                        help="The input code_and_msg path.")
    parser.add_argument("--nl_sol", default=None, type=str, required=True,
                        help="The input nl_sol path.")
    parser.add_argument("--additional_sol", default=None, type=str, required=True,
                        help="The input additional_sol path.")
    ...
    parser.add_argument('--infer_prefix', type=str, default='last', help="save prefix for inference")
    parser.add_argument('--sample_type', type=str, default='greedy', help="sample type for inference")

    parser.add_argument('--log_file', type=str, default='')
    parser.add_argument('--tensorboard_dir', type=str)  
    parser.add_argument('--use_pool', action='store_true', help="use cpu pool")
    parser.add_argument('--max_sol_num', type=int, default=5, help="max sol num for each question")
    parser.add_argument('--small_k', type=int, default=5, help="gen_code num for each question")
