...
def main():
    ...
    args_parser.add_argument("--inp_path", type=str, default="/home/zhangkechi/workspace/pycodegpt-edit/save/APPS_pycodegpt_e11_top_p:5_onDatasetFortest/test_no_code-checkpoint-epoch14-767880.skeleton")
    ...
    setattr(args, "save_path", args.inp_path.replace("skeleton", "eval_corpus.json"))
